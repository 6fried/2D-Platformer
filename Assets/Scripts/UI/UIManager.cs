...
public class UIManager : MonoBehaviour
{
    ...
    [Header("Map Building Feature")]
    [Tooltip("Brick Spawner used in the current scene")]
    public BrickSpawn brickSpawn = null;
    [Tooltip("Brick Background")]
    public GameObject brickBackground = null;

    /// <summary>
    /// Description:
    /// Disable the brick select button if no need of the feature.
    /// Input:
    /// none
    /// Return:
    /// void(no return)
    /// </summary>
    private void CheckBrickFeature()
    {
        if (brickSpawn != null)
